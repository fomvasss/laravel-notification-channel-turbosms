...
- Отримання списку відправників (альфа-імен) і дозволених для них країн
...
**Отримати список відправників (альфа-імен):**
...
//     'type'    => 'sms',
//     'name'    => 'MyCompany',
//     'status'  => 'international',   // або 'active', 'moderation' тощо
//     'profile' => [
//       'countries' => ['UA', 'PL', 'DE', ...],   // країни, дозволені для цього відправника
//       ...
//     ],
//   ],
// ]
...
Корисно, щоб перед відправкою перевірити, чи дозволений відправник для країни отримувача.
Тип за замовчуванням — `sms`, повертає `[]` у тестовому режимі.
